...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const defaultPhoenixPulseConfig = { chance: 0.05 };
  ...
  function getPhoenixPulseChance() {
    const rawChance = Number.isFinite(phoenixPulseConfig?.chance)
  ...
  setPhoenixPulseChance(phoenixPulseConfig.chance * 100, { save: false });
