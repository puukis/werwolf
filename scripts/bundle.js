 ...
 * This file concatenates the modular Werwolf scripts so that Node-based
 * tooling (Jest) can execute the legacy single-file implementation without
 * relying on the browser loader.
 */
